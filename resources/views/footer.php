...
<footer class="footer" style="background-color: black ">
    <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
        ...
        <div class="w-50">
            <h4 style="color: white">Need WishMyTrip Help?</h4>
            <p class="text-light">We would be more than happy to help you.<br> Our team
                advisor are 24/7 at your service to<br> help you.</p>
            <div class="media">
    ...
    <!--                <div class="container" id="harsh">-->
    <!--                    <button class="navbar-toggler" type="button"-->
    <!--                            data-toggle="collapse" data-target="#myTogglerNav1"-->
    <!--                            aria-controls="myTogglerNav"-->
    <!--                            aria-expanded="false" aria-label="Toggle navigation">-->
    <!--                        <span class="navbar-toggler-icon"></span>-->
    <!--                    </button>-->
    <!--                    <div class="collapse navbar-collapse" id="myTogglerNav1">-->
    <!--                        <div class="navbar-nav">-->
    ...
    <!--                            <a class="nav-item nav-link" href="Accessorie.php">Accessories</a>-->
    <!--                            <a class="nav-item nav-link" href="Careers.php">Careers</a>-->
    <!--                            <div>-->
    <!--                            <h4 style="color: white">Need WishMyTrip Help?</h4>-->
    <!--                            <p class="text-light">We would be more than happy to help you.<br> Our team-->
    <!--                                advisor are 24/7 at your service to<br> help you.</p>-->
